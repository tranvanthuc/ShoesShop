...
CREATE TABLE `addresses` (
  ...
  `distric` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `addresses` VALUES (1,'123TTT','Thanh Khe','Da Nang');
...
CREATE TABLE `products_sizes` (
  ...
  PRIMARY KEY (`id`),
  KEY `size_pro` (`product_id`),
  CONSTRAINT `size_pro` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `user_add` (`address_id`),
  CONSTRAINT `user_add` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`),
...
INSERT INTO `users` VALUES (1,1,1,'Thuc','Tran Van','thuc','123','',1,'01285136039','thuc.tv@neo-lab.vn');
...
-- Dump completed on 2017-10-05 11:23:06
